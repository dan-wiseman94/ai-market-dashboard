...
def test_convene_endpoint(monkeypatch):
    ...
    resp = APIClient().post("/api/warroom/runs/convene/", {"free_prompt": "q", "structure": "judge_panel"}, format="json")
...
def test_list_and_detail_runs():
    ...
    Message.objects.create(thread=th, role="assistant", content={"persona": "bull", "argument": "a"})
