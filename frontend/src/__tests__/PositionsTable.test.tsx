...
describe("PositionsTable", () => {
  beforeEach(() => {
    mockUsePositions.mockReturnValue({ data: undefined, isLoading: false, error: null } as ReturnType<typeof usePositions>);
  });

  it("renders loading state", () => {
    mockUsePositions.mockReturnValue({ data: undefined, isLoading: true, error: null } as ReturnType<typeof usePositions>);
  ...
  it("renders error message from error.message", () => {
    ...
    mockUsePositions.mockReturnValue({ data: undefined, isLoading: false, error: err } as ReturnType<typeof usePositions>);
    render(<PositionsTable />);
  ...
  it("renders empty state when data is an empty array", () => {
    mockUsePositions.mockReturnValue({ data: [], isLoading: false, error: null } as ReturnType<typeof usePositions>);
    render(<PositionsTable />);
  ...
  it("renders one row per position with Book totals footer", () => {
    ...
    mockUsePositions.mockReturnValue({ data: positions, isLoading: false, error: null } as ReturnType<typeof usePositions>);
    render(<PositionsTable />);
