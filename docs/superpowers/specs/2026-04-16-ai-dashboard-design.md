...
- **M10.5 — Provider parity (future)**: Bring tool-use / thinking / citations / files to OpenAI (GPT-5 responses API) and Local. Today these are silent no-ops for non-Claude providers.
