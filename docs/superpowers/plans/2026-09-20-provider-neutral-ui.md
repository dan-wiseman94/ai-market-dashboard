...
- **Backend harness** (the dev stack mounts the main checkout; tests run against the worktree through a compose override that already exists). Define once per shell:
  ```bash
